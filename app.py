...
# --- ESTILIZAÇÃO CSS (FOCO EM PADRONIZAÇÃO RÍGIDA E SIMETRIA) ---
st.markdown("""
    <style>
...
if st.sidebar.text_input("🔐 Acesso:", type="password").upper() == "PIB474":
    ...
    # --- LINHA DE AÇÕES (PADRONIZADA, ALFABÉTICA E SIMÉTRICA) ---
    st.markdown("---")
    ...
    with col_pla:
        df = pd.DataFrame([{"Data": d_str, "Total 9h": tot9, "Total 11h": tot11, "Geral": tot9+tot11}])
        buf = BytesIO()
